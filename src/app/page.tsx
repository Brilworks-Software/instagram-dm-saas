...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description:
        "Create engaging, optimized captions in seconds. AI learns your voice and generates content that performs.",
    ...
    },
    {
      ...
      description:
        "Find the right creators to collaborate with. Search by niche, location, and engagement metrics.",
    ...
    },
    {
      ...
      description:
        "Understand your performance. Track growth, engagement rates, and what content resonates most.",
    ...
    },
    {
      ...
      description:
        "Stay ahead with AI-powered hashtag recommendations by country and niche.",
    ...
    },
    {
      ...
      description:
        "Analyze your audience demographics, growth trends, and engagement patterns.",
    ...
    },
    {
      ...
      description:
        "Scale conversations intelligently without losing authenticity or brand voice.",
  ...
  const steps = [
    {
      ...
      title: "Connect Your Account",
      description:
        "Securely link your Instagram account in seconds. We never store your password.",
      icon: Instagram,
    },
    {
      number: "02",
      title: "Explore Analytics & Insights",
      description:
        "Get instant data on your performance, audience, and growth trends.",
      icon: BarChart3,
    },
    {
      number: "03",
      ...
      description:
        "Use AI tools to create captions, find hashtags, and plan posts that perform.",
      icon: Sparkles,
    },
    {
      number: "04",
      title: "Discover & Collaborate",
      description: "Find high-quality influencers and brands for partnerships.",
      icon: Users,
    },
    {
      number: "05",
      ...
      description:
        "Build long-term growth systems based on data and best practices.",
      icon: Rocket,
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "SocialOra's AI caption generator saves me hours every week. My engagement rates went up 120% in just 3 months.",
      rating: 5,
    },
    {
      name: "Marcus Johnson",
      ...
      content:
        "The influencer discovery tool helped me find perfect brand partners. It's like having a dedicated marketer on my team.",
      rating: 5,
    },
    {
      name: "Emily Rodriguez",
      ...
      content:
        "Finally one platform that does everything. No more juggling 10 different tools. SocialOra simplified our entire workflow.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center gap-3 py-2.5 sm:py-3">
              ...
              <p className="text-xs sm:text-sm font-semibold text-accent text-center">
                🎁 <span className="font-bold">Limited Time:</span> Claim Your
                Free Forever Plan - 1 Account + 40 DMs Daily, No Credit Card
                Required
              </p>
              <button
      ...
      {/* Enhanced Navigation */}
      <nav
        className={`fixed ${showTopBanner ? "top-[42px] sm:top-[44px]" : "top-0"} left-0 right-0 z-50 transition-all duration-300 ${
          scrollY > 50
          ...
          <div className="md:hidden border-t border-border bg-background/98 backdrop-blur-xl animate-slide-in">
            <div className="px-4 pt-4 pb-6 space-y-2">
              <Link href="/tools" className="block">
                <Button
                  variant="ghost"
                  className="w-full justify-start text-base hover:bg-accent/10 hover:text-accent transition-all"
                >
                  Tools
                </Button>
              </Link>
      ...
      {/* Hero Section */}
      <section
        className={`relative ${showTopBanner ? "pt-24 sm:pt-28 md:pt-32 lg:pt-36" : "pt-20 sm:pt-24 md:pt-28 lg:pt-32"} pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-screen flex items-center`}
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-foreground-muted max-w-3xl mx-auto mb-6 sm:mb-8 md:mb-10 animate-slide-up delay-200 leading-relaxed px-4">
              All-in-one tools for content creation, influencer discovery,
              analytics, and smart engagement.
              <span className="text-foreground font-semibold">
                {" "}
                Grow your Instagram with data, not guesswork.
              </span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-12 sm:mb-14 md:mb-16 animate-slide-up delay-400 px-4">
              ...
              <Button
                ...
                onClick={() => {
                  document
                    .getElementById("demo-video-section")
            ...
            <div className="max-w-2xl mx-auto mb-6 sm:mb-8 animate-slide-up delay-500 px-4">
              <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-background-elevated/50 border border-border/50 backdrop-blur-sm">
                ...
                <span className="text-xs sm:text-sm text-foreground-muted text-center">
                  No login required • AI-powered insights • Built for real
                  growth
                </span>
              </div>
            </div>
            ...
            <div
              ref={statsRef}
              className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto animate-fade-in delay-500 px-4"
            >
              {[
                { value: "10K+", label: "Active Users", icon: Users },
                { value: "2M+", label: "Messages Sent", icon: Send },
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-foreground-muted max-w-3xl mx-auto leading-relaxed">
              Creators, brands, and agencies use SocialOra to simplify their
              growth strategy with data-driven tools.
            </p>
                ...
                {[
                  {
                    ...
                    action: "Easy to use and intuitive",
                    time: "Essential",
                    image:
                  ...
                  },
                  {
                    ...
                    action: "Captions, hashtags, and insights",
                    time: "Game-changing",
                    image:
                      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=96&h=96&fit=crop&crop=faces",
                  },
                  {
                    ...
                    action: "Find perfect collaboration partners",
                    time: "Saves time",
                    image:
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                {/* Quote icon */}
                <div className="absolute top-8 right-8 text-6xl text-accent/10 group-hover:text-accent/20 transition-colors duration-300">
                  "
                </div>
          ...
          <div className="relative bg-gradient-to-br from-background-elevated via-background-elevated to-background-elevated/50 rounded-[3rem] p-12 sm:p-16 border border-accent/30 shadow-2xl overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-xl sm:text-2xl text-foreground-muted mb-10 max-w-3xl mx-auto leading-relaxed">
                ...
                who use data-driven tools to build real, sustainable growth.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                ...
                <Button
                  ...
                  onClick={() => {
                    window.open(
                      "https://www.youtube.com/watch?v=qfZBnw7G2Tw",
                      "_blank",
                      "noopener,noreferrer",
                    );
                  }}
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-foreground-muted mb-8">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-accent" />
                  <span>Free forever tools</span>
                </div>
                <div className="h-4 w-px bg-border"></div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-accent" />
                  <span>Designed for long-term scaling</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-3 pt-8 border-t border-border/50">
                <div className="flex -space-x-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-background-elevated shadow-lg"
                    >
                      <Image
                        src={img}
                        alt={`User ${i + 1}`}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-foreground-muted mb-6 max-w-md leading-relaxed">
                The ultimate AI-powered social media growth platform. Create
                better content, discover influencers, track performance, and
                scale strategically.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link
                    href="/tools"
                    className="text-foreground-muted hover:text-accent transition-colors flex items-center group"
                  >
                    <span>Tools</span>
          ...
          <div className="pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-foreground-muted">
              ...
              <span className="font-semibold text-foreground">
                Smarter Social Media Growth, Powered by AI.
              </span>
            </p>
